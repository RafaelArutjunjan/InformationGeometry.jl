...
export InterpolatedProfiles, ProfileBox, PracticallyIdentifiable
export ValInserter, ValInserter!, InsertIntoFirst, InsertIntoLast, FixParameters, FixNonIdentifiable, LinkParameters
...
export MultistartFit, LocalMultistartFit, MultistartResults, SubsetMultistartResults, WaterfallPlot, ParameterPlot, GetStepParameters
...
export PlotScalar, PlotLogLikelihood, Plot2DVF
export PlotScalarSlices, PlotVFSlices
export ResidualStandardError, PlotEllipses
...
function GetErrorParamInds end
...
SnoopPrecompile.@precompile_all_calls begin
    ...
    DataModel(DataSet(collect(1:14), [3, 8, 28, 75, 221, 291, 255, 235, 190, 126, 70, 28, 12, 5], 15ones(14); xnames= ["Days"], ynames=["Infected"]),
            ODEFunction(SIR!), X->([763.0-X[1], X[1], 0.0], @view X[2:3]), x->x[2], [0.614,0.00231,0.458], true; SkipTests=true, tol=1e-4)
