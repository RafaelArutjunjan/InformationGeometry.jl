...
ADtypeConverter(V::Val{:ChainRules}; kwargs...) = ADTypes.AutoChainRules(; kwargs...)
ADtypeConverter(V::Val{:Diffractor}; kwargs...) = ADTypes.AutoDiffractor(; kwargs...)
ADtypeConverter(V::Val{:Enzyme}; kwargs...) = ADTypes.AutoEnzyme(; kwargs...)
ADtypeConverter(V::Val{:FastDifferentiation}; kwargs...) = ADTypes.AutoFastDifferentiation(; kwargs...)
ADtypeConverter(V::Val{:FiniteDiff}; kwargs...) = ADTypes.AutoFiniteDiff(; kwargs...)
ADtypeConverter(V::Val{:FiniteDifferences}; kwargs...) = ADTypes.AutoFiniteDifferences(; kwargs...)
ADtypeConverter(V::Val{:ForwardDiff}; kwargs...) = ADTypes.AutoForwardDiff(; kwargs...)
ADtypeConverter(V::Val{:GTPSA}; kwargs...) = ADTypes.AutoGTPSA(; kwargs...)
ADtypeConverter(V::Val{:Mooncake}; kwargs...) = ADTypes.AutoMooncake(; kwargs...)
ADtypeConverter(V::Val{:MooncakeForward}; kwargs...) = ADTypes.AutoMooncakeForward(; kwargs...)
ADtypeConverter(V::Val{:PolyesterForwardDiff}; kwargs...) = ADTypes.AutoPolyesterForwardDiff(; kwargs...)
ADtypeConverter(V::Val{:Reactant}; kwargs...) = ADTypes.AutoReactant(; kwargs...)
ADtypeConverter(V::Val{:ReverseDiff}; kwargs...) = ADTypes.AutoReverseDiff(; kwargs...)
ADtypeConverter(V::Val{:Sparse}; kwargs...) = ADTypes.AutoSparse(; kwargs...)
ADtypeConverter(V::Val{:Symbolics}; kwargs...) = ADTypes.AutoSymbolics(; kwargs...)
ADtypeConverter(V::Val{:Tapir}; kwargs...) = ADTypes.AutoTapir(; kwargs...)
ADtypeConverter(V::Val{:TaylorDiff}; kwargs...) = ADTypes.AutoTaylorDiff(; kwargs...)
ADtypeConverter(V::Val{:Tracker}; kwargs...) = ADTypes.AutoTracker(; kwargs...)
ADtypeConverter(V::Val{:Zygote}; kwargs...) = ADTypes.AutoZygote(; kwargs...)

ADtypeConverter(T::ADTypes.AbstractADType; kwargs...) = T
ADtypeConverter(V::Val{T}; kwargs...) where T = T isa AbstractADType ? T : throw("ADtypeConverter not defined for $T")